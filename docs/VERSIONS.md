...
| contracts_v1 (rev) | nine-seat fold: nato/ksat/hacktivist folded; nsc human-playable; env_config adds clock_mode + release_policy; 5 new event types | pending | agent0-contracts | 2026-09-05 | human scope change, applied before merge and before any consumer, so a revision of v1 rather than a v2 |
